...
const Page: React.FC = () => {
  ...
  return (
    <section className='max-w-6xl'>
      ...
      /> */}
      <div className="flex h-96 items-end rounded-xl bg-[url('/assets/thailand/img11.jpg')]  bg-cover">
              ...
              >
                <div className='space-y-2'>
                  <h1 className='text-lg font-semibold text-gray-900'>
                    Day 1: Arrival at Bangkok-Phuket
                  </h1>
                  <h2 className='text-gray-800'>
                    <p>
                      Today arrive at Bangkok after immigration transfer to
                      Domestic terminal for Phuket. arrive at Phuket Airport
                      transfer to hotel
                      <span className='font-semibold'>
                        (CHECK IN TIME 2 PM)
                      </span>
                      . Hotel take little rest & in the evening Phuket roam
                      Phuket on your own.
                      <span className='font-semibold'>
                        Overnight at Phuket Hotel
                      </span>
                    </p>
                  </h2>
                </div>
                <div className='space-y-2'>
                  <h1 className='text-lg font-semibold text-gray-900'>
                    Day 2: Phuket (With Phi-Phi Island)
                  </h1>
                  <h2 className='text-gray-800'>
                    <p className='text-justify'>
                      After early morning breakfast, you will be transferred To
                      Phi – Phi Island by big boat (Island Tax own cost). Lunch
                      at Phi – Phi Island, enjoy Phi – Phi Island. Afternoon we
                      will back to Phuket & transfer to hotel, evening free for
                      personal activities,
                      <span className='font-semibold'>
                        overnight at Phuket Hotel.
                      </span>
                ...
                <div className='space-y-2'>
                  ...
                  <h2 className='text-gray-800'>
                    <p>
                      Early morning, we will be transferred to Phuket airport
                      for Bangkok. After reach at Bangkok airport proceed to
                      Pattaya. Arrive Pattaya hotel, take rest evening proceed
                      to Alcazar Show.
                      <span className='font-semibold'>
                ...
                <div className='space-y-2'>
                  ...
                  <h2 className='text-gray-800'>
                    <p>
                      ...
                      <span className='font-semibold'>
                        Overnight stay at Bangkok Hotel.
                      </span>
                    </p>
                  </h2>
                </div>
                <div className='space-y-2'>
                  ...
                  <h2 className='text-gray-800'>
                    <p>
                      After Breakfastfull day tour to Safari Park & Marine world
                      with lunch. After the tour reach Hotel in the evening.
                      <span className='font-semibold'>
                        Overnight stay at Bangkok Hotel.
                      </span>
                    </p>
                ...
                <div className='space-y-2'>
                  ...
                  <h2 className='text-gray-800'>
                    <p>
                      Today after Breakfastin the morning check-out hotel for
              ...
              <table className='w-full border-2 border-gray-300 text-left text-sm text-gray-800'>
                ...
                <tbody>
                  ...
                  <tr className='border-b bg-white'>
                    ...
                    <td className='px-6 py-4'>Beverly Plaza / Similar</td>
          ...
          <div className='mt-8 md:mt-0'>
            ...
            <div className='relative mt-4 overflow-x-auto'>
              <table className='w-full border-2 border-gray-300 text-center text-sm text-gray-800'>
                ...
                <tbody>
                  <tr className='border-b bg-white'>
                    <td className='px-6 py-4'>Rs. 38579/- per person</td>
                    <td className='px-6 py-4'>Rs. 41739/- per person</td>
                    <td className='px-6 py-4'>Rs. 55776/- per person</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <Modal
        ...
        selectedPackage='Best of Thailand'
      />
    </section>
  );
};
