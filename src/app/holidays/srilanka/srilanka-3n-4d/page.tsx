...
// import srilanka1 from '@public/assets/package.jpeg';
  ...
  return (
    <section className='max-w-6xl'>
      {/* <h1 className='text-center text-3xl font-bold text-cyan-600'>
        SRILANKA PACKAGE 3 NIGHTS / 4 DAYS
      </h1>
      <Image
        src={srilanka1}
        alt='srilanka1'
                ...
                <div className='space-y-2'>
                  ...
                  <h2 className='text-gray-800'>
                    <p className='text-justify'>
                      Visit Turtle Farm & Bentota City tourEnjoy water sports.
                    </p>
                  </h2>
                </div>
                <div className='space-y-2'>
              ...
              >
                <div className='space-y-2'>
                  ...
                  <ul className='ml-6 list-disc'>
                    ...
                    <li>03 Breakfasts + 03 Dinners at the hotel itself. </li>
                    <li>
                ...
                <div className='space-y-2'>
                  ...
                  <ul className='ml-6 list-disc'>
                    ...
                    <li>Lunch USD 10 per person per day </li>
                  </ul>
                </div>
              </Tab.Panel>
              <Tab.Panel
                ...
                <tbody>
                  <tr className='border-b bg-white'>
                    <td className='px-6 py-4'>
                      Rs. 21500/- Per person on twin / triple share.
                    </td>
                    <td className='px-6 py-4'>Rs. 23100/- per person</td>
                    <td className='px-6 py-4'>Rs. 26500/- per person</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <Modal
        ...
        selectedPackage='Srilanka 3 nights 4 days'
      />
    </section>
  );
};
