...
const Page: React.FC = () => {
  ...
  return (
    <section className='mx-auto max-w-3xl space-y-8'>
      ...
      <Image src={bali1} alt='bali1' quality={95} className='mx-auto' />
      ...
      <Tab.Group>
        <Tab.List className='flex space-x-1 rounded-xl bg-blue-950 p-1'>
          <Tab
            className={({ selected }): string =>
              classNames(
                'w-full rounded-lg py-1 text-sm font-medium leading-5 text-white sm:py-2.5',
        ...
        <Tab.Panels className='!mt-4 rounded-2xl border-2 border-gray-300'>
          ...
          >
            <div className='space-y-2'>
              ...
              <h2 className='flex flex-col text-gray-800'>
                ...
                <p>
                  Arrive at hotel and check in, after check in, free program at
                  own leisure
                </p>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-gray-800'>
                <p>Hotel Stay: As Chosen Hotel</p>
                <p>Highlight: Tour to Kintamani and exploring Ubud center</p>
                <p>
                  Breakfast at hotel. After breakfast, pick up from hotel and
                  transfer to visit:
                </p>
                <p>1) Tirta Empul – Holy Spring Temple.</p>
                <p>
                  2) Kintamani – The beautiful of Mount Batur Volcano and Batur
                  Lake view.
                </p>
            ...
            <div className='space-y-2'>
              ...
              <h2 className='flex flex-col text-gray-800'>
                ...
                <p>
                  2) Tanah Lot – The unique temple that standing on the rock in
          ...
          >
            <div className='space-y-2'>
              <h1 className='text-lg font-semibold underline'>Inclusions</h1>
              <ul className='ml-6 list-disc'>
                <li>
                  04 Nights’ accommodation with breakfast in choice of selected
                  hotel category
                </li>
                <li>
                  Return Airport Transfers from Bali Airport to Bali Hotel on
                  Private Basis
                </li>
                <li>Full Day Ubud & Kintamani Tour on Private Basis</li>
                <li>Daily Buffet Breakfast at Hotel</li>
                <li>
                  All Local Taxes & Charges Package government tax and service
                  charge.
                </li>
                <li>
                  All Local Taxes & Charges Package government tax and service
              ...
              <h1 className='text-lg font-semibold underline'>Exclusions</h1>
              <ul className='ml-6 list-disc'>
                <li>Which is not mentioned in above inclusions</li>
                <li>Any airfare, airport taxes international/ domestic</li>
                <li>
                  Any city tax or hotel fees if applicable need to be paid on
                  actual by guest
                </li>
                <li>
                ...
                <li>
                  Any Increase in the fuel surcharge or any kind of taxes levied
                  by the respective government or statutory bodies.
                </li>
              </ul>
            </div>
          </Tab.Panel>
          ...
          >
            <div className='space-y-2'>
              ...
              <ul className='ml-6 list-disc'>
                ...
                <li>
                  No Refund or Compensation on any changes on an ongoing trip
                </li>
                <li>
              ...
              <ul className='ml-6 list-disc'>
                <li>
                  ROE will be calculated at the rate prevailing on the date of
                  final payment
                </li>
                <li>
