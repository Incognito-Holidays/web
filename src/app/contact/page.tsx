    ...
    <div className='grid grid-cols-1 lg:grid-cols-2'>
      <div className='p-6'>
        ...
        <p className='mt-3 text-justify'>
          We appreciate you choosing Incognito Leisure Holidays Private Limited
          to handle your vacation arrangements. Any questions or requests you
          may have will be answered by us. Please don&apos;t hesitate to contact
        ...
        <div className=' mt-4 w-full rounded-lg border border-gray-200 p-4 shadow dark:border-gray-700 dark:bg-gray-800'>
          <h2 className='text-lg font-semibold'>Feedback and Suggestions:</h2>
          <p className=''>
            We appreciate your comments and ideas about how we may make our
            services better. Please contact us at kolkata@incognitoholidays.com
            with your ideas.
          </p>
        </div>
        <div className=' mt-4 w-full rounded-lg border border-gray-200 p-4 shadow dark:border-gray-700 dark:bg-gray-800'>
          ...
          <p className='text-justify'>
            ...
            office during business hours. Our staff will be happy to help you in
            person. Our goal at Incognito Leisure Holidays Private Limited is to
            make your trip unforgettable. Reach out to us right away, and
